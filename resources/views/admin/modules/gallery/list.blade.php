...
@push('meta')
<title>Gallerys | {{ config('app.name') }}</title>
<meta content="Gallerys" name="description" />
        ...
        <div class="breadcrumb__wrapper mb-25">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gallerys</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('gallery.create') }}">Add Gallery</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('gallery.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('gallery.list')}}";
    var listUrl = "{{route('gallery.index')}}";
    var deleteUrl = "{{route('gallery.delete')}}";
