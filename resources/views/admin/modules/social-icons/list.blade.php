...
@push('meta')
<title>Social Links | {{ config('app.name') }}</title>
<meta content="Social Links" name="description" />
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('social.create') }}">Add Social Link</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('social.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('social.list')}}";
    var listUrl   = "{{route('social.index')}}";
    var deleteUrl = "{{route('social.delete')}}";
