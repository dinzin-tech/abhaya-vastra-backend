...
@push('meta')
<title>Contact Us List | {{ config('app.name') }}</title>
<meta content="Contact Us List" name="description" />
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('contact-us.create') }}">Add Contact Details</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('contact-us.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('contact-us.list')}}";
    var listUrl   = "{{route('contact-us.index')}}";
    var deleteUrl = "{{route('contact-us.delete')}}";
