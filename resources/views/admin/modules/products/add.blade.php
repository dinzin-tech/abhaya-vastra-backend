...
function toggleQikinkFields(checked) {
    const qikinkDetails = document.getElementById('qikink_details_section');
    const qikinkSearch = document.getElementById('qikink_search_products_toggle');
    if (checked) {
        qikinkDetails.style.display = 'block';
        qikinkSearch.style.display = 'block';
    } else {
        qikinkDetails.style.display = 'none';
