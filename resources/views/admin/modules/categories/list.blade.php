...
<meta content="Categories" name="description" />
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('categories.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('categories.list')}}";
    var listUrl = "{{route('categories.index')}}";
