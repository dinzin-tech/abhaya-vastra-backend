...
<div class="app__slide-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-12 text-end">
            <a class="btn btn-primary" href="{{ route('privacy.create') }}">Add Privacy Policy</a>
        </div>
    </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('privacy.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('privacy.list')}}";
    var listUrl = "{{route('privacy.index')}}";
    var deleteUrl = "{{route('privacy.delete')}}";
