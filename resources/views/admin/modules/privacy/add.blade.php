...
@push('meta')
<title>{{$item ? 'Update' : 'Add'}} Privacy Policy | {{ config('app.name') }}</title>
<meta content="{{$item ? 'Update' : 'Add'}} Privacy Policy" name="description" />
...
<div class="app__slide-wrapper">
        ...
        <div class="breadcrumb__wrapper mb-25">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{$item ? 'Update' : 'Add'}} Privacy Policy</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xxl-12 col-xl-12 col-lg-12">
            <form class="card__wrapper" action="{{route('privacy.store')}}" method="post" onsubmit="return updateProfile(this)">
                @csrf
