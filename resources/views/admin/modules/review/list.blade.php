...
@push('meta')
<title>Client Reviews | {{ config('app.name') }}</title>
<meta content="Client Reviews" name="description" />
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{ route('reviews.list') }}">
                        <thead>
