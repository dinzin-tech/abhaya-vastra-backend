...
@push('meta')
<title>Short Videos | {{ config('app.name') }}</title>
<meta content="Short Videos" name="description" />
        ...
        <div class="breadcrumb__wrapper mb-25">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Short Videos</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('video.create') }}">Add Short Video</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('video.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('video.list')}}";
    var listUrl = "{{route('video.index')}}";
    var deleteUrl = "{{route('video.delete')}}";
