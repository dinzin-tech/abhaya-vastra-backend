...
@push('meta')
<title>SMTP Settings | {{ config('app.name') }}</title>
<meta content="SMTP Settings" name="description" />
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('smtp.create') }}">Add SMTP</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('smtp.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('smtp.list')}}";
    var listUrl   = "{{route('smtp.index')}}";
    var deleteUrl = "{{route('smtp.delete')}}";
