...
<div class="app__slide-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-12 text-end">
            <a class="btn btn-primary" href="{{ route('terms.create') }}">Add Terms & Conditions</a>
        </div>
    </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('terms.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('terms.list')}}";
    var listUrl = "{{route('terms.index')}}";
    var deleteUrl = "{{route('terms.delete')}}";
