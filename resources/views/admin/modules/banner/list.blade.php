...
@push('meta')
<title>Banners | {{ config('app.name') }}</title>
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('banner.create') }}">Add Banner</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('banner.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('banner.list')}}";
    var listUrl = "{{route('banner.index')}}";
    var deleteUrl = "{{route('banner.delete')}}";
