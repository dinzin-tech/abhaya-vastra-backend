    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col-12 text-end">
                <a class="btn btn-primary" href="{{ route('faq.create') }}">Add FAQ</a>
            </div>
        </div>
        ...
        <div class="col-xxl-12">
            <div class="card__wrapper">
                <div class="table__wrapper table-responsive">
                    <table class="table mb-20 multiple_tables" id="record-list" data-url="{{route('faq.list')}}">
                        <thead>
...
<script type="text/javascript">
    var searchUrl = "{{route('faq.list')}}";
    var listUrl = "{{route('faq.index')}}";
    var deleteUrl = "{{route('faq.delete')}}";
